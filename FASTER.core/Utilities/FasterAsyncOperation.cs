...
{
    /// <summary>
    /// Base class for FasterAsyncOperation
    /// </summary>
    public abstract class FasterAsyncOperation
    {
        ...
        private static void AvailableSentinel(object s) => Debug.Fail($"{nameof(FasterAsyncOperation)}.{nameof(AvailableSentinel)} invoked with {s}");
        ...
        private static void CompletedSentinel(object s) => Debug.Fail($"{nameof(FasterAsyncOperation)}.{nameof(CompletedSentinel)} invoked with {s}");
        ...
        protected static void ThrowIncompleteOperationException() =>
            throw new InvalidOperationException("InvalidOperation_IncompleteAsyncOperation");
        ...
        protected static void ThrowMultipleContinuations() =>
            throw new InvalidOperationException("InvalidOperation_MultipleContinuations");
        ...
        protected static void ThrowIncorrectCurrentIdException() =>
            throw new InvalidOperationException("InvalidOperation_IncorrectToken");
    }


    public partial class FasterAsyncOperation<TResult>
    {
        private void UnsafeQueueSetCompletionAndInvokeContinuation() =>
            Task.Factory.StartNew(s => ((FasterAsyncOperation<TResult>)s).SetCompletionAndInvokeContinuation(), this,
    ...
    public partial class FasterAsyncOperation<TResult> : FasterAsyncOperation, IValueTaskSource, IValueTaskSource<TResult>
    {
        ...
        public FasterAsyncOperation(bool runContinuationsAsynchronously, CancellationToken cancellationToken = default, bool pooled = false)
        {
            ...
            if (cancellationToken.CanBeCanceled)
            {
                ...
                {
                    var thisRef = (FasterAsyncOperation<TResult>)s;
        ...
        public FasterAsyncOperation<TResult> Next { get; set; }
        ...
        private void SignalCompletion()
        {
            if (_continuation != null || Interlocked.CompareExchange(ref _continuation, s_completedSentinel, null) != null)
            {
                ...
                else if (_schedulingContext is SynchronizationContext sc)
                {
                    ...
                    {
                        sc.Post(s => ((FasterAsyncOperation<TResult>)s).SetCompletionAndInvokeContinuation(), this);
                        return;
                    }
                }
                else
    ...
    internal sealed class VoidAsyncOperationWithData<TData> : FasterAsyncOperation<VoidResult>
    {
        /// <summary>Initializes the interactor.</summary>
        /// <param name="runContinuationsAsynchronously">true if continuations should be forced to run asynchronously; otherwise, false.</param>
        /// <param name="cancellationToken">The cancellation token used to cancel the operation.</param>
